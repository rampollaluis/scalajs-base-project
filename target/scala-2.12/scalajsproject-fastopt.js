...
$c_Ltutorial_webapp_TutorialApp$.prototype.main__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_Node = (function(target) {
  var this$1 = $m_Lscalatags_JsDom$all$();
  var jsx$5 = this$1.button__Lscalatags_JsDom$TypedTag();
  $m_Lscalatags_JsDom$all$();
  var jsx$4 = new $c_Lscalatags_JsDom$StringFrag().init___T("Click me");
  var jsx$3 = $m_Lscalatags_JsDom$all$().onclick__Lscalatags_generic_Attr();
  var jsx$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, target$1) {
    return (function() {
      var this$3 = $m_Lscalatags_JsDom$all$();
      var jsx$2 = this$3.p__Lscalatags_JsDom$TypedTag();
      var array = [($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("This is how you control the dom with scalajs"))];
      return target$1.appendChild(jsx$2.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array)).render__Lorg_scalajs_dom_raw_Element())
    })
  })(this, target));
  ...
  var array$1 = [jsx$4, jsx$3.$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair(jsx$1, new $c_Lscalatags_LowPriorityImplicits$$anon$2().init___Lscalatags_LowPriorityImplicits__F1(this$7, ev))];
  var btn = jsx$5.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$1));
  var this$10 = $m_Lscalatags_JsDom$all$();
  var jsx$18 = this$10.div__Lscalatags_JsDom$TypedTag();
  var this$11 = $m_Lscalatags_JsDom$all$();
  var jsx$17 = this$11.h1__Lscalatags_JsDom$TypedTag();
  var array$2 = [($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Hello World!"))];
  var jsx$16 = jsx$17.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$2));
  var this$15 = $m_Lscalatags_JsDom$all$();
  var jsx$15 = this$15.h3__Lscalatags_JsDom$TypedTag();
  $m_Lscalatags_JsDom$all$();
  var jsx$14 = new $c_Lscalatags_JsDom$StringFrag().init___T("This is ");
  var this$17 = $m_Lscalatags_JsDom$all$();
  var jsx$13 = this$17.i__Lscalatags_JsDom$TypedTag();
  var array$3 = [($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("with"))];
  var array$4 = [jsx$14, jsx$13.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$3)), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T(" the Scalatags library"))];
  var jsx$12 = jsx$15.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$4));
  var this$24 = $m_Lscalatags_JsDom$all$();
  var jsx$11 = this$24.p__Lscalatags_JsDom$TypedTag();
  $m_Lscalatags_JsDom$all$();
  var jsx$10 = new $c_Lscalatags_JsDom$StringFrag().init___T("The quick brown ");
  var this$26 = $m_Lscalatags_JsDom$all$();
  var jsx$9 = this$26.b__Lscalatags_JsDom$TypedTag();
  var array$5 = [($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("fox"))];
  var jsx$8 = jsx$9.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$5));
  $m_Lscalatags_JsDom$all$();
  var jsx$7 = new $c_Lscalatags_JsDom$StringFrag().init___T(" jumps over the lazy ");
  var this$31 = $m_Lscalatags_JsDom$all$();
  var jsx$6 = this$31.i__Lscalatags_JsDom$TypedTag();
  var array$6 = [($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("dog"))];
  var array$7 = [jsx$10, jsx$8, jsx$7, jsx$6.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$6)), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("."))];
  var array$8 = [jsx$16, jsx$12, jsx$11.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$7)), btn];
  return target.appendChild(jsx$18.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$8)).render__Lorg_scalajs_dom_raw_Element())
});
$c_Ltutorial_webapp_TutorialApp$.prototype.$$js$exported$meth$main__Lorg_scalajs_dom_raw_HTMLDivElement__O = (function(target) {
  return this.main__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_Node(target)
});
$c_Ltutorial_webapp_TutorialApp$.prototype.main = (function(arg) {
  var prep = arg;
  return this.$$js$exported$meth$main__Lorg_scalajs_dom_raw_HTMLDivElement__O(prep)
});
...
/** @constructor */
function $c_Ltutorial_webapp_TutorialApp0$() {
  $c_O.call(this)
}
$c_Ltutorial_webapp_TutorialApp0$.prototype = new $h_O();
$c_Ltutorial_webapp_TutorialApp0$.prototype.constructor = $c_Ltutorial_webapp_TutorialApp0$;
/** @constructor */
function $h_Ltutorial_webapp_TutorialApp0$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_TutorialApp0$.prototype = $c_Ltutorial_webapp_TutorialApp0$.prototype;
$c_Ltutorial_webapp_TutorialApp0$.prototype.init___ = (function() {
  return this
});
$c_Ltutorial_webapp_TutorialApp0$.prototype.main__Lorg_scalajs_dom_raw_HTMLDivElement__V = (function(target) {
  target.innerHTML = "\n    <div>\n      <h1>Hello World!</h1>\n      <h3>This is made without the Scalatags library.</h3>\n      <p>\n        The quick brown <b>fox</b>\n        jumps over the lazy <i>dog</b>\n      </p>\n    </div>\n    "
});
$c_Ltutorial_webapp_TutorialApp0$.prototype.$$js$exported$meth$main__Lorg_scalajs_dom_raw_HTMLDivElement__O = (function(target) {
  this.main__Lorg_scalajs_dom_raw_HTMLDivElement__V(target)
});
$c_Ltutorial_webapp_TutorialApp0$.prototype.main = (function(arg) {
  var prep = arg;
  return this.$$js$exported$meth$main__Lorg_scalajs_dom_raw_HTMLDivElement__O(prep)
});
var $d_Ltutorial_webapp_TutorialApp0$ = new $TypeData().initClass({
  Ltutorial_webapp_TutorialApp0$: 0
}, false, "tutorial.webapp.TutorialApp0$", {
  Ltutorial_webapp_TutorialApp0$: 1,
  O: 1
});
$c_Ltutorial_webapp_TutorialApp0$.prototype.$classData = $d_Ltutorial_webapp_TutorialApp0$;
var $n_Ltutorial_webapp_TutorialApp0$ = (void 0);
function $m_Ltutorial_webapp_TutorialApp0$() {
  if ((!$n_Ltutorial_webapp_TutorialApp0$)) {
    $n_Ltutorial_webapp_TutorialApp0$ = new $c_Ltutorial_webapp_TutorialApp0$().init___()
  };
  return $n_Ltutorial_webapp_TutorialApp0$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
$c_Lscalatags_JsDom$all$.prototype.i__Lscalatags_JsDom$TypedTag = (function() {
  ...
  var hi = (32 & b.hi$2);
  if ((hi === 0)) {
    return this.i$lzycompute__p1__Lscalatags_JsDom$TypedTag()
  } else {
    return this.i$1
  }
});
...
$c_Lscalatags_JsDom$all$.prototype.i$lzycompute__p1__Lscalatags_JsDom$TypedTag = (function() {
  var b = this.bitmap$0$1;
  var hi = (32 & b.hi$2);
  if ((hi === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1;
    this.i$1 = $as_Lscalatags_JsDom$TypedTag($f_Lscalatags_jsdom_TagFactory__typedTag__T__Z__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag(this, "i", false, ns));
    var b$1 = this.bitmap$0$1;
    var lo = b$1.lo$2;
...
$e.tutorial = ($e.tutorial || {});
$e.tutorial.webapp = ($e.tutorial.webapp || {});
$e.tutorial.webapp.TutorialApp0 = $m_Ltutorial_webapp_TutorialApp0$;
}).call(this);
